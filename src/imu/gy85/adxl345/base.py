...
class ADXL345_Base:
    ...
    def _equal(self, value, reference, error_margin=0.2):
    ...
    def calibrate(self):
        ...
        if self._equal(abs_x, 1) and self._equal(abs_y, 0) and self._equal(abs_z, 0):
            ...
            raise ValueError(f"Could not determine ADXL position. One axe should be set in field of gravity: {abs_x}, {abs_y}, {abs_z}")
